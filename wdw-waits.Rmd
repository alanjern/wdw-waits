...
```{r load-data}
pirates_waits <- read_csv(here("data", "pirates_of_caribbean.csv")) %>% clean_names()
mine_train_waits <- read_csv(here("data", "7_dwarfs_train.csv")) %>% clean_names()
splash_waits <- read_csv(here("data", "splash_mountain.csv")) %>% clean_names()

# https://gist.github.com/shivaas/4758439
holidays <- read_csv(here("data", "us_holidays.csv")) %>% clean_names()

# https://www.ocps.net/about_us/calendars/historical_calendars
ocps_breaks <- read_csv(here("data", "ocps_break_dates.csv")) %>% clean_names()
```
...
```{r load-hs-data}
rnrc_waits <- read_csv(here("data", "rock_n_rollercoaster.csv")) %>% clean_names()
slinky_dog_waits <- read_csv(here("data", "slinky_dog.csv")) %>% clean_names()
alien_saucers_waits <- read_csv(here("data", "alien_saucers.csv")) %>% clean_names()
toy_story_mania_waits <- read_csv(here("data", "toy_story_mania.csv")) %>% clean_names()
```
